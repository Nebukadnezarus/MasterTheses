...
\newcommand*{\getAuthor}{B. Sc. William Constantin Rosenhahn}
\newcommand*{\getDoctype}{Master's Thesis}
\newcommand*{\getSupervisor}{Prof. Dr.-Ing. Markus Ryll}
\newcommand*{\getAdvisor}{M. Sc. Lukas Pries}
...
\input{chapters/03_dynamics_model}
\input{chapters/04_platform_design}
\input{chapters/05_control_architecture}
\input{chapters/06_experimental_setup}
\input{chapters/07_experiments_evaluation}
