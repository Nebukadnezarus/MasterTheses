...
\begin{itemize}
\item Translational outer loop controller (300\,Hz)
\item Force-to-attitude mapping
\item Geometric attitude and rate controller (300\,Hz)
\item INDI inner loop torque refinement (300\,Hz)
\item Motor allocation
