...
\subsubsection{Thrust Characterization and Command Mapping}\label{sec:thrust-characterization}
...
The complete experimental results, fitted models, and analysis are presented in Section~\ref{sec:thrust_map_results}.
