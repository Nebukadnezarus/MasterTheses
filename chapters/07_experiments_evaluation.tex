...
\begin{enumerate}
  ...
  \item \textbf{Circular trajectory tracking} at the AIDA flight arena demonstrated sub-decimeter position accuracy (\SI{0.064}{\meter} to \SI{0.184}{\meter} RMS error) across speeds from \SI{3}{\meter\per\second} to \SI{8}{\meter\per\second}, with sustained centripetal accelerations up to 2.8g, validating robust INDI-based control without explicit aerodynamic modeling.
